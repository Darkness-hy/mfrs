...
class Potential(nn.Module):
    ...
    def goal_emb(self, state, goal):
        ...
        if self.goal_dim == 6:
            ...
            vec = torch.cat([state, vec_1, vec_2, vec_3, vec_4], dim=0)
        else:
            ...
            vec = torch.cat([state, vec_1, vec_2, vec_3, vec_4, vec_5, vec_6, vec_7, vec_8], dim=0)
    ...
    def forward(self, s, a, g):
        ...
        x = F.relu(self.l1(torch.cat([s, a], dim=0)))
        x = F.relu(self.l2(x))
        p = self.l3(x)
